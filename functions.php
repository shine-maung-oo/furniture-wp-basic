...
function _tk_scripts() {
	...
	wp_enqueue_style( '_bootstrap', THEME_DIR_URI . '/includes/shwe-mi-furniture/css/bootstrap.min.css' );

	// load bootstrap css
	wp_enqueue_style( '_tk-bootstrap', THEME_DIR_URI . '/includes/shwe-mi-furniture/css/style.css' );
	...
	// load bootstrap js
	wp_enqueue_script('_bootstrapjs', THEME_DIR_URI . '/includes/shwe-mi-furniture/js/bootstrap.bundle.min.js', array('jquery') );
